...
//xhr  reuqest for weath data 
   
//          const xhr = new XMLHttpRequest;
// xhr.responseType ="json";

// const API="http://api.openweathermap.org/data/2.5/weather?lat=52.522794999999995&lon=-1.8436450000000002&appid=37d8911cc47bc893ab2f518f05bacfcc";
// xhr.open('GET',API)
...
const API=`https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${long}&appid=37d8911cc47bc893ab2f518f05bacfcc`;
xhr.open('GET',API)
   ...
   if(xhr.readyState === XMLHttpRequest.DONE)
      {
         ...
         // stores data inside renderWeather parameter
         renderWeather(data)
         return xhr.response;
      }
